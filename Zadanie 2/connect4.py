...
# Implementacja:
# Program włącza się konsolowo w środowisku PyCharm z wgranym modułem EasyAI
# Przy odpalaniu program zgłasza brak modułu i proponuje jego wgranie jednym kliknięciem.
# Dodatkowo należy wgrać Interpreter NumPy. Instrukcja:
...
if __name__ == '__main__':
    ...
    from easyAI import Human_Player, AI_Player, Negamax, DUAL
